...
final int count = 0;
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss") ;
    		...
    		File file = new File("Tweetsitdefr3" + dateFormat.format(date) + ".json");
                if(!file.exists()){
    			file.createNewFile();
    		}
 ...
 // TwitterStream twitterStream = new TwitterStreamFactory(cb.build()).getInstance();
                      TwitterStream twitterStream = TwitterStreamBuilderUtil2.getStream();
...
*/
    ...
    String[] keywords = {" #TRUMP", "#trump", "#donaldtrump", "#presidentelect","Trump", "Donald Trump", "#notmypresident","#presidentelecttrump", "#recount", "#postcardavalanche", "#NotMyPresident","electoral college", "#president"};
    String[] lang = {"it","de","fr"};
    fq.track(keywords);
    fq.language(lang);
