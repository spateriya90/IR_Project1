...
final int count = 0;
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss") ;
    		...
    		File file = new File("Syria" + dateFormat.format(date) + ".json");
                if(!file.exists()){
    			file.createNewFile();
    		}
...
//String stat = status.getUser() + status.getLang() + status.getText()
  //                  + status.isRetweet();
    ...
    String[] keywords = {"#syria","#freesyria","#assad","#prayforsyria","#freepalestine","#withsyria","fuckassad",
