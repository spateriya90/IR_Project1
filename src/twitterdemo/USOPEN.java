...
final int count = 0;
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss") ;
    		...
    		File file = new File("USOPEN" + dateFormat.format(date) + ".json");
                if(!file.exists()){
    			file.createNewFile();
    		}
  ...
  //                  + status.isRetweet();
            ...
            if(rt == false)
            {
                try {
                    ...
                    Logger.getLogger(USOPEN.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
                    ;
        }
    ...
    String[] keywords = {"#USOpen","#usopen","Djokovic","#tennis", "#usopen2016","#atp","#grandslam","#wta"
