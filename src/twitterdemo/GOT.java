...
final int count = 0;
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss") ;
    		...
    		File file = new File("GOT" + dateFormat.format(date) + ".json");
                if(!file.exists()){
    			file.createNewFile();
    		}
 ...
 // TwitterStream twitterStream = new TwitterStreamFactory(cb.build()).getInstance();
                      TwitterStream twitterStream = TwitterStreamBuilderUtil3.getStream();
  ...
  //                  + status.isRetweet();
            ...
            if(rt == false)
            {
                try {
                    ...
                    Logger.getLogger(GOT.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
                    ;
        }
