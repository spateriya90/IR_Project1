...
final int count = 0;
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss") ;
    		...
    		File file = new File("Turk" + dateFormat.format(date) + ".json");
                if(!file.exists()){
    			file.createNewFile();
    		}
  ...
  //                  + status.isRetweet();
            ...
            if(rt == false)
            {
                try {
                    ...
                    Logger.getLogger(MainTR.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
                    ;
        }
...
"IPhone7", "iPhone", "# iPhone7", "# iPhone", "# iPhone7Plus", "# iphone7plus", "# iphone",
"# Iphone7", "elma", "# elma", "# iphone7launch", "# Apple Watch", "# Apple Watch", "# appleevent","Apple", "# Elma", "Apple Ürünü 2", "Apple Ürünü","# Elections2016", "# trump2016", "# hillary2016",
            "Hillary Clinton,", "Donald Trump", "Trump",
...
"#USOpen", "# Usopen", "Cokoviç", "#, tenis", "# usopen2016", "# ATP", "# Grandslam", "# WTA",
