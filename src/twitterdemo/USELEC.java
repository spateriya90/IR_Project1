...
final int count = 0;
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss") ;
    		...
    		File file = new File("TweetsEN" + dateFormat.format(date) + ".json");
                if(!file.exists()){
    			file.createNewFile();
    		}
  ...
  //                  + status.isRetweet();
           ...
           // {
                try {
                    ...
                    Logger.getLogger(USELEC.class.getName()).log(Level.SEVERE, null, ex);
                }
          //  }
                    ;
        }
    ...
    /*String[] keywords = {"#elections2016","#trump2016","#hillary2016",
